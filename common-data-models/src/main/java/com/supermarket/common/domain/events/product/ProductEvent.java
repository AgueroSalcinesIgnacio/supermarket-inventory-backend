 ...
 *
 * <p>
 * This event is published to Kafka whenever a product is created, updated, or
 * deleted. It contains the product data and operation details for consumption
...
public class ProductEvent extends DomainEvent {
    ...
    public static ProductEvent created(ProductEntity product) {
        ProductEvent event = ProductEvent.builder().productData(ProductEventData.from(product)).build();
     ...
     * @param product
     *            the product data before deletion
