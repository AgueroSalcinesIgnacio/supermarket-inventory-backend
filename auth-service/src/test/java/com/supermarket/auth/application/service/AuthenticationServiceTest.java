...
class AuthenticationServiceTest {
    ...
    void register_ShouldThrowException_WhenUsernameExists() {
        // Given
        RegisterRequestDTO request = RegisterRequestDTO.builder().username("existing").email("new@example.com").build();
    ...
    void register_ShouldThrowException_WhenEmailExists() {
        // Given
        RegisterRequestDTO request = RegisterRequestDTO.builder().username("new").email("existing@example.com").build();
    ...
    void login_ShouldThrowException_WhenUserNotFound() {
        // Given
        LoginRequestDTO request = LoginRequestDTO.builder().username("unknown").password("password123").build();
