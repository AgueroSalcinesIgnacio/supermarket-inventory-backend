 ...
 *
 * <p>
 * This configuration customizes the OpenAPI specification that is automatically generated by
 * SpringDoc. It provides API metadata including title, version, description, and contact
 * information. The generated OpenAPI specification is available at:
 *
 * <ul>
...
public class OpenApiConfig {
   ...
   *
   * <p>
   * Provides API title, version, description, and contact details that are displayed in the Swagger
